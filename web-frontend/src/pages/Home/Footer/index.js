        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid md:grid-cols-12 gap-8 lg:gap-20 mb-8 md:mb-12">
            ...
            <div className="md:col-span-4 lg:col-span-5">
              ...
              <div className="text-gray-400">Di sản văn hóa Việt Nam</div>
            </div>
            ...
            <div className="md:col-span-8 lg:col-span-7 grid sm:grid-cols-3 gap-8">
              ...
              <div className="text-sm">
                ...
                <ul>
                  <li className="mb-1">
                    <Link to="/" className="text-gray-400 hover:text-gray-100 transition duration-150 ease-in-out">Web</Link>
                  </li>
                </ul>
              </div>
              ...
              {/* 3rd block */}
              <div className="text-sm">
                <h6 className="text-gray-200 font-medium mb-1">Nguồn lực</h6>
                <ul>
                  <li className="mb-1">
                    <Link to="/" className="text-gray-400 hover:text-gray-100 transition duration-150 ease-in-out">Hello</Link>
                  </li>
                </ul>
              </div>
              ...
              {/* 4th block */}
              <div className="text-sm">
                <h6 className="text-gray-200 font-medium mb-1">Công ty</h6>
                <ul>
                  <li className="mb-1">
                    <Link to="/" className="text-gray-400 hover:text-gray-100 transition duration-150 ease-in-out">Nhóm 7</Link>
                  </li>
                </ul>
              </div>
          ...
          <div className="md:flex md:items-center md:justify-between">
            ...
            {/* Copyrights note */}
            <div className="text-gray-400 text-sm mr-4">Copyright &copy; 2024 dct.</div>
